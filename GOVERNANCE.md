...
`cloud-itonami-iso3166-lso` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Lesotho-licensed counsel or a registered agent for whatever licensed
representation the law of Lesotho requires for public-procurement
filings.
