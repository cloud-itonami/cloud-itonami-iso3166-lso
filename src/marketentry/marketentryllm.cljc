(ns marketentry.marketentryllm
  ...
  the Lesotho (LSO) public-sector market-entry compliance actor.
...
(defn- propose-submit
  ...
  (let [e (store/engagement db subject)]
    {:summary    (str subject " 向けポータル提出提案"
                      (when e (str " (operator=" (:operator e) ")")))
     :rationale  (if e
                   (str "seeking-contractor-registration?=" (:seeking-contractor-registration? e)
                        " contractor-category=" (:contractor-category e)
                        " claimed-contractor-registration-fee=" (:claimed-contractor-registration-fee e)
