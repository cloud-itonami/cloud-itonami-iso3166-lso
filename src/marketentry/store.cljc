(ns marketentry.store
  "SSoT for the Lesotho (LSO) market-entry compliance actor, behind a
...
(defn demo-data
  ...
  `:seeking-contractor-registration?` / `:contractor-category` /
  `:claimed-contractor-registration-fee` are ground truth for the
  flagship check (gov.ls's own Contractors Registration Certificate
  category-fee schedule)."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Maseru Fabrication Ltd" :portal "companies.org.ls"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :seeking-contractor-registration? false :contractor-category nil
             :claimed-contractor-registration-fee nil
             :drafted? false :submitted? false
             :jurisdiction "LSO" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "companies.org.ls"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :seeking-contractor-registration? false :contractor-category nil
             :claimed-contractor-registration-fee nil
    ...
    "eng-3" {:id "eng-3" :operator "Thaba-Bosiu Systems Ltd" :portal "companies.org.ls"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "LSO" :status :intake}
    "eng-4" {:id "eng-4" :operator "Maluti Construction Co." :portal "companies.org.ls"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :seeking-contractor-registration? true :contractor-category :D
             :claimed-contractor-registration-fee 1000.0
             :drafted? false :submitted? false
             :jurisdiction "LSO" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               seeking-contractor-registration? contractor-category claimed-contractor-registration-fee
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? seeking-contractor-registration?) (assoc :engagement/seeking-contractor-registration? seeking-contractor-registration?)
    contractor-category                   (assoc :engagement/contractor-category contractor-category)
    (some? claimed-contractor-registration-fee) (assoc :engagement/claimed-contractor-registration-fee claimed-contractor-registration-fee)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/seeking-contractor-registration? :engagement/contractor-category :engagement/claimed-contractor-registration-fee
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :seeking-contractor-registration? (boolean (:engagement/seeking-contractor-registration? m))
     :contractor-category (:engagement/contractor-category m)
     :claimed-contractor-registration-fee (:engagement/claimed-contractor-registration-fee m)
