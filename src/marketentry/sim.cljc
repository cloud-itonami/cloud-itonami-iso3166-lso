...
(defn -main [& _]
  (let [db (store/seed-db)
        actor (op/build db)]
    (println "== engagement/intake eng-1 (LSO, clean) ==")
    ...
    (println "== jurisdiction/assess eng-4 (sets up contractor-registration-fee-mismatch) ==")
    ...
    (println "== filing/submit eng-4 (contractor-registration-fee-mismatch -> HARD hold) ==")
